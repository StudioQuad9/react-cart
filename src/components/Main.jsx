...
import WarauWa from "../containers/ReadMoreLinks/WarauWa";
import KanauWaGosyoku from "../containers/ReadMoreLinks/KanauWaGosyoku"
import KanauWaGolf from "../containers/ReadMoreLinks/KanauWaGolf"
...
import KanauWa5CLimted from "../containers/ReadMoreLinks/KanauWa5CLimted";
...
import SyuinChouLimited from "../containers/ReadMoreLinks/SyuinChouLimited"
...
const Main = ({ 
  ...
  return (
    <>
      ...
      <div
        className={`wrapper ${isGraduallyAppearActive ? "active" : ""}`}
        ref={targetElemRef}
      >
        <h3>
          お守り・授与品の
        ...
        <div className="head-line">
          <div className="copy">
            <p>
              御神札やお守り・授与品は神社に参拝いただき御社頭でお受けいただくのが本来ですが、
              <br className="line-break" />
              どうしても諸事情や遠方で直接御参りできない方は下記よりお求めください。
              <br />
              昨今の事情により通常3、4日かかります事お含みおきください。
              <br />
              お求めの数量を入れ、『一覧に追加』ボタンを押してください。最後に画面右上の『一覧
      ...
      <div className="read-more-links">
        <OfudaFamilySafety
          selectedItemId={
            selectedItemId === "ofuda_family_safety"
              ? "ofuda_family_safety"
              : null
          }
        ...
        <OfudaYakuYoke
          selectedItemId={
            selectedItemId === "ofuda_yaku_yoke" ? "ofuda_yaku_yoke" : null
          }
          handleBackClick={handleBackClick}
        />
        <OfudaSenRyu
          selectedItemId={
            selectedItemId === "ofuda_sen_ryu" ? "ofuda_sen_ryu" : null
          }
          handleBackClick={handleBackClick}
        />
        <ThokonTukusuMamori
          selectedItemId={
            selectedItemId === "thokon_tukusu_mamori"
              ? "thokon_tukusu_mamori"
              : null
          }
          handleBackClick={handleBackClick}
        />
        <KyugiThokonMamori
          selectedItemId={
            selectedItemId === "kyugi_thokon_mamori"
              ? "kyugi_thokon_mamori"
              : null
          }
          handleBackClick={handleBackClick}
        ...
        <ThokonMamoriKado
          selectedItemId={
            selectedItemId === "thokon_mamori_kado"
              ? "thokon_mamori_kado"
              : null
          }
          handleBackClick={handleBackClick}
        ...
        <ThokonMamoriMaru
          selectedItemId={
            selectedItemId === "thokon_mamori_maru"
              ? "thokon_mamori_maru"
              : null
          }
          handleBackClick={handleBackClick}
        ...
        <KiseiMamori
          selectedItemId={
            selectedItemId === "kisei_mamori" ? "kisei_mamori" : null
          }
          handleBackClick={handleBackClick}
        />
        <DeauWa
        ...
        <TrafficSafetySticker
          selectedItemId={
            selectedItemId === "traffic_safety_sticker"
              ? "traffic_safety_sticker"
              : null
          }
          handleBackClick={handleBackClick}
        />
        <TrafficSafetyCarMamori
          selectedItemId={
            selectedItemId === "traffic_safety_car_mamori"
              ? "traffic_safety_car_mamori"
              : null
          }
          handleBackClick={handleBackClick}
        />
        <WarauWa
          selectedItemId={selectedItemId === "warau_wa" ? "warau_wa" : null}
          handleBackClick={handleBackClick}
        />
        <KanauWaGosyoku
          selectedItemId={
            selectedItemId === "kanau_wa_gosyoku" ? "kanau_wa_gosyoku" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaSoccer
          selectedItemId={
            selectedItemId === "kanau_wa_soccer" ? "kanau_wa_soccer" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaBaseball
          selectedItemId={
            selectedItemId === "kanau_wa_baseball" ? "kanau_wa_baseball" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaVolley
          selectedItemId={
            selectedItemId === "kanau_wa_volley" ? "kanau_wa_volley" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaBasket
          selectedItemId={
            selectedItemId === "kanau_wa_basket" ? "kanau_wa_basket" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaTennis
          selectedItemId={
            selectedItemId === "kanau_wa_tennis" ? "kanau_wa_tennis" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaBadminton
          selectedItemId={
            selectedItemId === "kanau_wa_badminton"
              ? "kanau_wa_badminton"
              : null
          }
          handleBackClick={handleBackClick}
        ...
        <KanauWaTableTennis
          selectedItemId={
            selectedItemId === "kanau_wa_table_tennis"
              ? "kanau_wa_table_tennis"
              : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaGolf
          selectedItemId={
            selectedItemId === "kanau_wa_golf" ? "kanau_wa_golf" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWaAll
          selectedItemId={
            selectedItemId === "kanau_wa_all" ? "kanau_wa_all" : null
          }
          handleBackClick={handleBackClick}
        />
        <KanauWa5CLimted
          selectedItemId={
            selectedItemId === "kanau_wa_5climted" ? "kanau_wa_5climted" : null
          }
          handleBackClick={handleBackClick}
        />
        <HairBand
        ...
        <KanauWaHashi
          selectedItemId={
            selectedItemId === "kanau_wa_hashi" ? "kanau_wa_hashi" : null
          }
          handleBackClick={handleBackClick}
        />
        <SyuinChou
        ...
        />
        <SyuinChouLimited
          selectedItemId={selectedItemId === "syuin_chou_limited" ? "syuin_chou_limited" : null}
          handleBackClick={handleBackClick}
        />
        <MariDorei
